        ...
        >
            ...
            <div className="flex items-center gap-2" onClick={(e) => e.stopPropagation()}>
                <button
                    ...
                    className="flex items-center gap-1 bg-white/10 hover:bg-white/20 active:scale-95 text-white font-black text-xs px-2.5 py-1.5 rounded-xl border border-white/10 transition-all"
                ...
                <button
                    ...
                    className="flex items-center gap-1 bg-primary/20 hover:bg-primary/30 active:scale-95 text-primary font-black text-xs px-3 py-1.5 rounded-xl border border-primary/30 transition-all"
